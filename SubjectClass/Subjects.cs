using ObserverDesignPattern.SubjectClass.Subject;
using System;
...
namespace ObserverDesignPattern.SubjectClass
{
    public class Subjects : ISubject
    {
        ...
        public Subjects(string productName, int productPrice, string availability)
        {
